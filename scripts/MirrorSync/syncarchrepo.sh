...
# Lockfile path
lock="/mnt/mirror/syncarchrepo.lck"
...
rsync_cmd() { # -4 força uso de ipvo4 -6 ipv6 sem ele define solo
	local -a cmd=(rsync -4 -rlptH --safe-links --delete-delay --delay-updates
